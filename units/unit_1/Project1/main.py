...
## test accuracy for average perceptron = 0.8180 incorrect
'''
...
stopwords_dict = p1.bag_of_words(train_texts, "stopwords.txt")

train_bow_features_stop = p1.extract_bow_feature_vectors(train_texts, stopwords_dict)
val_bow_features_stop = p1.extract_bow_feature_vectors(val_texts, stopwords_dict)
test_bow_features_stop = p1.extract_bow_feature_vectors(test_texts, stopwords_dict)

avg_peg_train_accuracy, avg_peg_test_accuracy = \
    p1.classifier_accuracy(p1.pegasos, train_bow_features_stop, test_bow_features_stop,train_labels, test_labels,T=T,L=L)
print("{:50} {:.4f}".format("Training accuracy for Pegasos:", avg_peg_train_accuracy))
print("{:50} {:.4f}".format("Test accuracy for Pegasos:", avg_peg_test_accuracy))


print('9.1 Change Binary Features to counts Features')

train_bow_features_stop = p1.extract_bow_feature_vectors(train_texts, stopwords_dict, 1)
val_bow_features_stop = p1.extract_bow_feature_vectors(val_texts, stopwords_dict, 1)
test_bow_features_stop = p1.extract_bow_feature_vectors(test_texts, stopwords_dict, 1)
