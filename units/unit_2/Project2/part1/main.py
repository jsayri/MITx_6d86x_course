...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    train_y_new, test_y_new = update_y(train_y, test_y)
    test_error = compute_test_error_mod3(test_x, train_y_new, theta, temp_parameter)
    return test_error
...
print('softmax pca test_error=', test_error_pca)
...
print('softmax pca test_error=', test_error_cube)
