...
# print('SVM one vs. rest test_error - C=0.5:', run_svm_one_vs_rest_on_MNIST(C=0.5))
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    # theta = read_pickle_data('theta_mod3.pkl.gz')
    test_error_mod3 = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)
...
print('softmax test_error_mod3 T=1.0: ', run_softmax_on_MNIST_mod3(temp_parameter=1))
